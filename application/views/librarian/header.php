...
<?php $settingsvalue = $this->librarian_model->getSettingsValue(); ?>
<?php if(!empty($this->session->userdata('user_login_id'))){
    $userid = $this->session->userdata('user_login_id');
    $profilevalue = $this->librarian_model->GetProfileValue($userid);
}
?>
<body>
                    ...
                    <ul>
                        ...
                        <li data-id="product" id="product" class="main">
                            ...
                            <ul aria-expanded="true" class="">
                                <li><a href="<?php echo base_url(); ?>librarian/product_list">List Product</a></li>
                            </ul>
                        </li>
