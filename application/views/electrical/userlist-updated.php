                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo base_url(); ?>electrical/View_profile?U=<?php echo base64_encode($value->user_id) ?>">
                                        ...
                                        <td><a href="<?php echo base_url(); ?>electrical/View_profile?U=<?php echo base64_encode($value->user_id) ?>"><?php echo $value->full_name ?></a></td>
                                        <td>
        ...
        <div class="modal-content">
            ...
            <form role="form" action="updateValue" id="UserValueUpdate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body">
                   ...
                   <div class="form-group clearfix">
                        <label for="password" class="col-md-3">Set Password</label>
                        <div class="col-md-9">
...
<script type="text/javascript">
    $(document).ready(function() {
        $(".userbutton").click(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>electrical/viewUserDataBYID?id=' + iid,
                method: 'GET',
                data: '',
                dataType: 'json',
