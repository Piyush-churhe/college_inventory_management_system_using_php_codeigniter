...
<?php $settingsvalue = $this->electrical_model->getSettingsValue(); ?>
<?php if(!empty($this->session->userdata('user_login_id'))){
    $userid = $this->session->userdata('user_login_id');
    $profilevalue = $this->electrical_model->GetProfileValue($userid);
}
?>
<body>
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu topbar-dropdown-wrapper" role="menu">
                                    <ul class="dropdown-user-inner">
                                        ...
                                        <li class="divider"></li> 
                                        <li data-id="users" class="main"><a href="<?php echo base_url();?>electrical/View_profile?U=<?php echo base64_encode($this->session->userdata('user_login_id')); ?>"><i class="icon-user mr10"></i> Profile</a></li>
                    ...
                    <ul>
                        ...
                        <li data-id="users" id="users" class="main">
                            ...
                            <ul aria-expanded="true" class="">
                                <li><a href="<?php echo base_url(); ?>electrical/List_user_updated">List Teacher</a></li>
                                <li><a href="<?php echo base_url(); ?>electrical/Add_User">Add Teacher</a></li>
                            </ul>
                        </li>
                        <?php if($this->session->userdata('user_type') == 'Admin'){ ?>
                        <li data-id="user-role" id="user-role" class="main">
                            <a class="" href="<?php echo base_url(); ?>electrical/ListGroup" aria-expanded="false">
                        ...
                        <li data-id="product" id="product" class="main">
                            ...
                            <ul aria-expanded="true" class="">
                                <li><a href="<?php echo base_url(); ?>electrical/product_list">List Product</a></li>
                            </ul>
                        </li>
