                                    ...
                                    <table id="example" class="table table-condensed responsive table_custom" cellspacing="0" width="100%">
                                        ...
                                        <?php $sr=1; foreach($productlist as $value): ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url();?>workshop/product_details?P=<?php echo base64_encode($value->pro_id) ?>"><?php echo $value->pro_name ?><a/></td>
                                               ...
                                               <!--  <td class="action-buttons">
                                                    <a href="<?php echo base_url();?>workshop/Getprodatabyid?P=<?php echo base64_encode($value->pro_id) ?>">
                                                        <i class="icon-pencil"></i>
                                                    </a>
                                                    <a onclick="confirm('Are you sure want to delet this product?')" href="<?php echo base_url();?>workshop/Delet_ProductInfo?D=<?php echo base64_encode($value->pro_id) ?>">
                                                        <i class="icon-close"></i>
                                                    </a>                           
                                                </td> -->

                                                <td>
    <?php echo $value->WS_Approval ?>
</td>
                                            <td>  
            ...
            <form role="form" action="updateProValue" id="UserValueUpdate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body">
                     <div class="form-group clearfix">
                        ...
                        <div class="col-md-9">
                            <select name="WS_Approval" id="WS_Approval" class="form-control" style="width: 100%" required>                                       
...
<script type="text/javascript">
    $(document).ready(function() {
        $(".userbutton").click(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>workshop/viewProDataBYID?id=' + iid,
                method: 'GET',
                data: '',
                dataType: 'json',
    ...
    $(document).ready(function() {
        $("#btnSubmit").click(function(event) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>workshop/updateProValue",
                data: data,
                dataType: 'json',
                processData: false,
                contentType: false,
