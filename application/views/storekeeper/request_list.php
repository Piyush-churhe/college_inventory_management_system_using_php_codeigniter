<?php $this->load->view('storekeeper/header'); ?>
                                       ...
                                       <thead>
                                        ...
                                        <?php $sr=1; foreach($productlist as $value): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $value->pro_name ?><a/></td>
                                                ...
                                                <td><?php echo $value->principal_approval ?></td>
                                                <td><?php echo $value->Hod_Approval ?></td>
                                                <td><?php echo $value->WS_Approval ?></td>
                                                <td><?php echo $value->Storekeeper_Approval ?></td>
                                               <!--  <td class="action-buttons">
                                                    <a href="<?php echo base_url();?>storekeeper/Getprodatabyid?P=<?php echo base64_encode($value->pro_id) ?>">
                                                        <i class="icon-pencil"></i>
                                                    </a>
                                                    <a onclick="confirm('Are you sure want to delet this product?')" href="<?php echo base_url();?>storekeeper/Delet_ProductInfo?D=<?php echo base64_encode($value->pro_id) ?>">
            ...
            <form role="form" action="updateProValue" id="UserValueUpdate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body">
                     <div class="form-group clearfix">
                        ...
                        <div class="col-md-9">
                            <select name="Storekeeper_Approval" id="Storekeeper_Approval" class="form-control" style="width: 100%" required>                                       
...
<script type="text/javascript">
    $(document).ready(function() {
        $(".userbutton").click(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>storekeeper/viewProDataBYID?id=' + iid,
                method: 'GET',
                data: '',
                dataType: 'json',
    ...
    $(document).ready(function() {
        $("#btnSubmit").click(function(event) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url(); ?>storekeeper/updateProValue",
                data: data,
                dataType: 'json',
                processData: false,
                contentType: false,
...
<?php $this->load->view('storekeeper/footer'); ?>