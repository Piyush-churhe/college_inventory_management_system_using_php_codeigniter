...
<?php $settingsvalue = $this->storekeeper_model->getSettingsValue(); ?>
<?php if(!empty($this->session->userdata('user_login_id'))){
    $userid = $this->session->userdata('user_login_id');
    $profilevalue = $this->storekeeper_model->GetProfileValue($userid);
}
?>
<body>
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu topbar-dropdown-wrapper" role="menu">
                                    <ul class="dropdown-user-inner">
                                        ...
                                        <li class="divider"></li> 
                                        <li data-id="users" class="main"><a href="<?php echo base_url();?>storekeeper/View_profile?U=<?php echo base64_encode($this->session->userdata('user_login_id')); ?>"><i class="icon-user mr10"></i> Profile</a></li>
                    ...
                    <ul>
                        ...
                        <li data-id="product" id="product" class="main">
                            ...
                            <ul aria-expanded="true" class="">
                                <li><a href="<?php echo base_url(); ?>storekeeper/view_category">Department</a></li>
                                <li><a href="<?php echo base_url(); ?>storekeeper/view_subcategory">Subcategory</a></li>
                                <li><a href="<?php echo base_url(); ?>storekeeper/product_list">List Product</a></li>
                                <li><a href="<?php echo base_url(); ?>storekeeper/View_Product">Add Product</a></li>
                            </ul>
                        </li>
                         ...
                         <li data-id="product" id="product" class="main">
                            ...
                            <ul aria-expanded="true" class="">
                                <li><a href="<?php echo base_url(); ?>storekeeper/request_list">Requested List </a></li>
