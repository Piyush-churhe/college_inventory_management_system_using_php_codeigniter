                ...
                <div class="col-md-12">
                    <div class="content_wrapper">
                        <div class="table_banner clearfix">
                            <h5 class="table_banner_title">Teachers</h5>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                           <!--  <a href="<?//php echo base_url(); ?>computer/View_profile?U=<?//php echo base64_encode($value->user_id) ?>">
                                                    <i class="icon-eye"></i>
                                                </a> -->
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header modal-primary">
                ...
                <h4 class="modal-title" id="modal-label">Teacher</h4>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $(".userbutton").click(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>computer/viewUserDataBYID?id=' + iid,
                method: 'GET',
                data: '',
                dataType: 'json',
