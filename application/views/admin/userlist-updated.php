        ...
        <div class="modal-content">
            ...
            <form role="form" action="updateValue" id="UserValueUpdate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body">
                    ...
                    <div class="form-group clearfix">
                        <label for="role" class="col-md-3">Set Position</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group clearfix">
                        <label for="department" class="col-md-3">Set Department</label>
                        <div class="col-md-9">
        ...
        $(".userbutton").click(function(e) {
            ...
            $.ajax({
                ...
                theForm.find('[name="userid"]').val(response.uservalue.user_id).end()
                        ...
                        .find('[name="department"]').val(response.uservalue.department).end();
                        .find('[name="position"]').val(response.uservalue.position).end();
