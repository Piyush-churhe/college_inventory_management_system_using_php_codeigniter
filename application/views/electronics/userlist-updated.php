                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?php echo base_url(); ?>electronics/View_profile?U=<?php echo base64_encode($value->user_id) ?>">
                                        ...
                                        <td><a href="<?php echo base_url(); ?>electronics/View_profile?U=<?php echo base64_encode($value->user_id) ?>"><?php echo $value->full_name ?></a></td>
                                        <td>
...
<script type="text/javascript">
    $(document).ready(function() {
        $(".userbutton").click(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>electronics/viewUserDataBYID?id=' + iid,
                method: 'GET',
                data: '',
                dataType: 'json',
