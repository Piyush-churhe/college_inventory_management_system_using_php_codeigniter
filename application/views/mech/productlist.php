                                    ...
                                    <table id="example" class="table table-condensed responsive table_custom" cellspacing="0" width="100%">
                                        ...
                                        <?php $sr=1; foreach($productlist as $value): ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url();?>mech/product_details?P=<?php echo base64_encode($value->pro_id) ?>"><?php echo $value->pro_name ?><a/></td>
                                                ...
                                                <td class="action-buttons">
                                                    <a href="<?php echo base_url();?>mech/Getprodatabyid?P=<?php echo base64_encode($value->pro_id) ?>">
                                                        <i class="icon-pencil"></i>
                                                    </a>
                                                    <a onclick="confirm('Are you sure want to delet this product?')" href="<?php echo base_url();?>mech/Delet_ProductInfo?D=<?php echo base64_encode($value->pro_id) ?>">
